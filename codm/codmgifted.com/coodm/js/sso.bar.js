	...
	var layoutGeneration = function(layoutItems) {
		...
		**/
		...
		if (SSO.utility.getDomain() == "callofduty.com") {
			//defaultSSOElements.desktop = ['desktopStart', 'mobileButton', 'masthead', 'siteLinks', 'support',  'accountsNew', 'rightSideStart', 'loginRegisterButtons', 'locale',  'siteLinksRight', 'rightSideEnd', 'desktopEnd'];
			//defaultSSOElements.mobile = ['mobileStart', 'mobileButton', 'masthead', 'rightSideStart','mobileLoginRegister', 'mobilePurchase', 'rightSideEnd', 'mobileEnd', 'modalStart', 'siteLinks', 'accountsNew', 'locale', 'modalEnd'];
	...
	var hybridEventHandlers = function () {
		...
		if (SSO.utility.getDomain() == "callofduty.com") {
	        $(window).resize(function() {
	            if((window.innerWidth > 1100) && ($(".mobile.sso-modal").attr("aria-expanded") == "true")) {
		...
		if (SSO.utility.getDomain() == "callofduty.com") {
			...
			//COD ONLY - Mobile Modal Nav - Tabbing
			...
			//COD ONLY - Header Nav - Scroll Fade in/out
	        var $header = $("#cdo-bar");	
	        var lastScrollTop = 0;
